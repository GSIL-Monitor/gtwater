package com.gt.manager.entity.wtProfitSystem;
...
public class WtProfitSystem implements Serializable {
	...
	*/
	...
	// Empty Constructor
	public WtProfitSystem() {
		super();
	}
	
	// Full Constructor
	public WtProfitSystem(Long id, Long profitId, String orderCode, Integer orderNum, Long unitPrice, String skuCode, Long profitMoney, Long orderTime, Integer proportion, Long createTime, Long createId, Integer delStatus) {
		this.id =  id;
