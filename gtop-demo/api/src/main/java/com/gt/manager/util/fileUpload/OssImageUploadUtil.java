...
//        System.out.println(data);
        ...
        System.out.println("-----------正常" + OssImageUploadUtil.OSS_GTWATER_URL + realPath + newFileName);
		return new DataMessage(DataMessage.RESULT_SUCESS,OssImageUploadUtil.OSS_GTWATER_URL+realPath + newFileName, "上传成功！");
    }
	 ...
	 * return  boolen
	 * 查看图片域名 img.goola.cn 
	 * http://img.goola.cn/gtwater/1535082655775.png
	 */
	public static void main(String[] args) throws Exception {
		
		File file=new File("C:\\Users\\Administrator\\Desktop\\img\\banner1.png");
		String name = System.currentTimeMillis()+"";
		System.out.println(name);
		System.out.println();
		System.out.println(UploadOss.putObject(new FileInputStream(file), file.length(), "gtwater/", name+".png", 1));
	}
