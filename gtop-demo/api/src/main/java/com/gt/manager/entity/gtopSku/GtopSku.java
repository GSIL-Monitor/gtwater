package com.gt.manager.entity.gtopSku;
...
public class GtopSku implements Serializable {
	...
	*/
	...
	// Full Constructor
	public GtopSku(Long id, Long branchesId, Long pId, String goodsCode, Long brandId, String skuCode, String goodsBar, String typeCode, String goodsSpec, BigDecimal goodsWeight, Integer goodsUtil, String goodsSize, String goodsColor, Integer status, Long costPrice, Long price, Integer onSales, Long sellPrice, Long shelfOnTime, String shellOffReason, Long createId, Long createTime, Long updateId, Long updateTime, Integer delState, Long version) {
		this.id =  id;
