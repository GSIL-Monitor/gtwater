...
//import com.gt.manager.merchant.resource.GoodsResources;

import com.gt.manager.account.resource.WtBranchesAccountController;
...
//    	this.register(GoodsResources.class);
//        this.register(ReceiveAddressResources.class);
        this.register(RequestContextFilter.class);
        this.register(WtBranchesAccountController.class);
...
//        config.setResourcePackage("com.gt");
