package com.gt.manager.qrcode.utils;
...
public class QrCodeGenerateUtil {
     ...
     * @param height
     */
    public static BufferedImage createCode(String text, int width, int height) {
        ...
        try {
            ...
            //        + File.separator + text + '.' + imgFormat);
            //MatrixToImageWriter.writeToFile(bitMatrix, imgFormat, outputFile);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
